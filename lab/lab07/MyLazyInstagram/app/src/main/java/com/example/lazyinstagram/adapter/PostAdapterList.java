...
public class PostAdapterList extends RecyclerView.Adapter<PostAdapterList.Holder>{
    ...
    public PostAdapterList(Context context) {
    ...
    public Holder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        itemView = inflater.inflate(R.layout.post_item_list, null, false);
